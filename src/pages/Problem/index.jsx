...
const Problem = () => {
  ...
  useEffect(() => {
    ...
    const fetchSubmissions = async () => {
      ...
      try {
        const res = await fetch(
          `${import.meta.env.VITE_API_BASE_URL}/api/problems/submissions/my?problem_id=${Number(
            problemId
          )}`,
          {
            method: "GET",
  ...
  useEffect(() => {
    ...
    const fetchSolutions = async () => {
      ...
      try {
        const url = new URL(
          `${import.meta.env.VITE_API_BASE_URL}/api/solutions/problem/${problemId}`
        );
  ...
  const handlevote = async (vote, solutionId) => {
    const res = await fetch(
      `${import.meta.env.VITE_API_BASE_URL}/api/solutions/${solutionId}/vote`,
      {
        method: "POST",
        headers: {
  ...
  const handleRun = async () => {
    try {
      ...
      const response = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/problems/run`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
